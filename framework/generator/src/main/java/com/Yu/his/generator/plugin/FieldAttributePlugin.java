...
public class FieldAttributePlugin extends PluginAdapter {
    ...
    public List<GeneratedJavaFile> contextGenerateAdditionalJavaFiles(IntrospectedTable introspectedTable) {
        ...
        root.addImportedType("com.Yu.his.generator.help.DbField");
        root.addImportedType("com.Yu.his.generator.help.FieldResult");
        ...
        for (IntrospectedColumn column : allColumns) {
            ...
            Field field = new Field(varName,
                    new FullyQualifiedJavaType("com.Yu.his.generator.help.DbField"));
            ...
            setMethod.setReturnType(new FullyQualifiedJavaType("com.Yu.his.generator.help.FieldResult"));
