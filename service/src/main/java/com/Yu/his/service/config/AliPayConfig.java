...
public class AliPayConfig {
    ...
    public static String alipayPublicKey = "MIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQEAjd";
    // 服务器异步通知页面路径  需http://格式的完整路径，其实就是支付完成后返回的页面URL
//    public static String notify_url = neturl+"/alipay/notify_url";
    public static String notifyUrl = "http://4acg48.natappfree.cc/api/alipay/notify";
